...
class animation():
    def __init__(self):
        ...
        self._x = np.linspace(0 ,100, 5, dtype=int)
        self._y = 0
        ...
        self.line2 = self.ax.plot(self._x[4], self._y[0], label=f'v0 = {self._y[1:]/self._x[1:]} m/s')[0]
        self.ax.set(xlim=[0, 3], ylim=[-4, 10])
        #self.ax.legend()
    ...
    def connect_generate():
        """Connect the animation with the generate"""
        pass
